...
const OrdersPage = () => {
    ...
    const downloadTableData = () => {
        ...
        exportFromJSON({
            data: tableData,
            fileName,
            fields: ['_id', 'userID', 'productName', 'price', 'orderStatus', 'paymentMethod', 'createdAt'],
            exportType
        })
    }
    ...
    return (
        <section id="orders" className="min-h-screen overflow-y-auto">
            ...
            <div id="tableSection" className="para-base lg:para-lg">
                ...
                <div className="bg-white shadow-md rounded-md p-3">
                    ...
                    <div className="overflow-x-auto">
                        <Table tableData={tableData} pageNo={pageNo} type={'orders'} />
                    </div>
